...
stmt.addBatch("Update location set count=count-1 where location='"+loc+"'");
stmt.addBatch("Update location set count=count+1 where location='"+preloc+"'");
