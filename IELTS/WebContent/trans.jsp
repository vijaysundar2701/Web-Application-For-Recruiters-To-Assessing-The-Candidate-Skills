            ...
            <nav class="main-navigation">
                    ...
                    <form action="adminlogout" method="get">
                        <ul class="menu-list">
                            <li><a class="nav-link" href="http://localhost:8080/IELTS/adminindex.jsp">Home</a></li>
                             <li><a class="nav-link" href="http://localhost:8080/IELTS/loctransfer.jsp">VenueTransfer</a></li>
                ...
                <div class="mobile-menu hidden-lg-up">
                    <ul class="mobile-menu-list">
                        <li><a class="nav-link" href="http://localhost:8080/IELTS/adminindex.jsp">Home</a></li>
                         <li><a class="nav-link" href="http://localhost:8080/IELTS/loctransfer.jsp">VenueTransfer</a></li>
                              <li><a class="nav-link" href="http://localhost:8080/IELTS/datetransfer.jsp">DateTransfer</a></li>
