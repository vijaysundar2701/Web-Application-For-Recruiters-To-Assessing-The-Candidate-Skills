            ...
            <nav class="main-navigation">
                <div class="container clearfix">
                    ...
                    <div class="main-menu hidden-md-down">
                        <ul class="menu-list">
                            <li><a class="nav-link" href="http://localhost:8080/IELTS/segregation.html">Back</a></li>
        ...
        <section id="Services">
            ...
            <div class="col-12">
				...
				<span class="login100-form-title p-b-37">
					Segregate the result
				</span>
<h4> The Segreagation process is done by separating the result according to the catagory.</h4> 
				 <div style="margin:3em;">
<form action="process.jsp" method="post">
<button type="submit" class="btn btn-primary btn-lg " id="load1" data-loading-text="<i class='fa fa-circle-o-notch fa-spin'></i> Processing Order">Process</button>
